...
- 📊 Create multi-machine production charts
- 📈 Show production trends over time
- 🔍 Analyze production data by different time periods
- 🎨 Generate colorful visualizations with different chart types

**Try asking me:**
- "Show all machines production in April with bar chart"
- "Plot daily production trends for this month"
- "Compare production by machine and shift"
...
st.set_page_config(page_title="Enhanced Production Analytics Bot", page_icon="📊")

st.title("Enhanced Production Analytics Bot 📊")
